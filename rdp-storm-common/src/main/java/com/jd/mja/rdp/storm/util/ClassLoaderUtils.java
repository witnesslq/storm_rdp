...
public class ClassLoaderUtils {
    ...
    public static URL getResource(String resourceName, Class callingClass) {
        ...
        if (url == null) {
            ...
            System.out.println("Thread.currentThread():"+url.getPath());
        }

        if (url == null) {
            url = callingClass.getClassLoader().getResource(resourceName);
        }else{
            System.out.println("ClassLoaderUtils.getClassLoader():"+url.getPath());

        }
        System.out.println("callingClass.getClassLoader():"+url.getPath());
        return url;
    }
